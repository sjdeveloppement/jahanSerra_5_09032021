...
function showcartLocalStorage() {
    ...
    //////////////////////////////////
    /* Form validation*/
    // with RegExp constructor of expected relational expression
    //firstName
    /**
    ...
    btnorder.addEventListener('click', (event) => {
        ...
        if (contactValue.length == 5 && session != null) {
            ...
            function envoieVersServeur(jsonBody) {
                ...
                fetch("https://oc-p5-api.herokuapp.com/api/cameras/order", {           //en local  http://localhost:3000/api/cameras/order
                method: "POST",
                headers: {
